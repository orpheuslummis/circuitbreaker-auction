...
import circuit from "../circuits/target/circuitbreaker_auction.json"
//import { Fr } from '@aztec/bb.js';

// createSyncStoragePersister for external storage
...
function Component() {
  ...
  return (
    <div className="gameContainer">
      ...
      {storedSignature && availableAddresses.map(acc => <><button onClick={() => console.log('action')}>
        Claim with connected account: {acc}
      </button><br /></>)}
    </div>
  );
}
